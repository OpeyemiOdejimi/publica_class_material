...
# x (exclusive create): creates the file omly if it doesn't exist; errors if it does (safer if you don't want to overwrite by mistake).
...
# 3. Open a file
# * Opening a file prepares if for reading or writing.
...
# Write to a file
# * Write puts text into the file. write() does not add newlines automatically (you add \nyourself).
...
with open(file_path, "w", encoding="utf-8") as f:
    ...
    f.write(" - Revise Python file handlin\n")
...
try:
    ...
    print("Ops! That file doesn't exist yet")
