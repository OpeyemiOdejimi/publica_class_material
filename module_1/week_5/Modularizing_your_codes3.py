...
#   * A recipe tells you howto make a cake, but the receipe is not eligible.
...
#   * Classes help us:
#       * Organize Code: Keep related data and fucntions together
...
#       * Scale Applications; Build lafrger, more complex programs
...
# Whst is self? Self is a reference to the specific object you're working with. It's like saying "this particular student" or "this specific bank account."

# Real-World ANanlogy

#       * In a classroom with mny students:
...
# * In Porogramming:
#      * self.name means "this specific objects's name"
...
#   * 2. All methopds takes self as first parameter
...
# What are Attributes? Attributes are the characteristics, prpoerties, or data that dewscribe an object. They answer the question "What does this object look like?" or "What information does this object store?"
...
# These are all attributes - they decribe WHO the person is, not what they can DO.
...
# Methods ate fucntions that belomng to a class. They define what actions an object can perform. They answer the questions "What can this object do?"
...
# These are all methids - they describe what the person can DO, not what they look like.
...
#     return "Academic sessions run from September to July"


# How Attributes and Methods Work Togther
#   * The Relationship
...
# # * Given this class, identify tyhe attributes and methods
...
# # Abstraction means hiding complex implementation details and showing only the essential features. It's like using a remote coon trol - you press buttons to change channels, but you don't need to know how the TV  circuits work.


# # Real-World Analogy

# #   * When you board a Lagos Danfo
#       * What you see: Door, seats, conductor, drive
...
#   * The bus abstracts all the complex mechanical details. You just need to know how to be a passanger.
...
# # Simple abstraction for phone inteface
...
#     * FDlexibility: Implementation can change without affecting users
#     * Reuseability: Same interface works for different implementations
...
#           * Parent (Fathetr): Adebayo Odundimu - has surname, family traditions, property
#           * Child 1 (son): Kemi Ogundimu - inherits surname, traditions, gets family properly +add his own career as doctor.
#           * Child 2 (Daughter): Tunde Ogundimu - inherits surname, traditiond, get family property + adds her own career as engineer

#    * The children inherit from their father but also have own unique characteristics.
...
# Inheritance Heiracy Visualization
...
class Child(Father, Mother):   # Inherits from boith parents
    pass
